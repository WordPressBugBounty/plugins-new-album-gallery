...
// js
wp_enqueue_script('awl-theme-bootstrap-js', plugin_dir_url(__FILE__) . '../js/bootstrap.min.js', array('jquery'), AG_PLUGIN_VER, true);

// css
wp_enqueue_style('awl-theme-bootstrap-css', plugin_dir_url(__FILE__) . 'css/bootstrap.min.css', array(), AG_PLUGIN_VER);
wp_enqueue_style('awl-theme-css', plugin_dir_url(__FILE__) . 'css/our-theme.css', array(), AG_PLUGIN_VER);
wp_enqueue_style('awl-theme-font-awesome-css', plugin_dir_url(__FILE__) . 'css/font-awesome.min.css', array(), AG_PLUGIN_VER);
