(function(blocks, editor, element, components) {
    ...
    registerBlockType('new-album-gallery/album-gallery-block', {
        title: 'Album Gallery',
        description: 'Display an individual album gallery.',
        icon: 'images-alt2',
        category: 'widgets',
        attributes: {
            galleryId: {
        ...
        edit: function(props) {
            ...
            var gData = window.ag_gutenberg_data || { galleries: [] };
            ...
            return [
                ...
                el('div', { key: 'view', className: 'ag-block-placeholder-preview' },
                    el('div', {
                        style: {
                        ...
                        el('h4', { style: { margin: '0 0 5px 0', fontSize: '16px', fontWeight: '700' } }, 'Album Gallery Block'),
